...
/**
 * Loads templates from the plugin folder.
 *
 *
 * @since      1.0.0
 * @package    Panel_Press
 ...
 */
class Panel_Press_Template_Loader {
	/**
	 ...
	 * @type string
	 */
    protected $filter_prefix = 'panel_press';
	 ...
	 * @type string
	 */
    protected $theme_template_directory = 'templates'; // or 'your-plugin-templates' etc.
	 ...
	 * @type string
	 */
    protected $plugin_directory = plugin_dir_path( dirname( __FILE__ ) );
